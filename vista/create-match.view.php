...
require "../../private/controlador/config.controller.php"; // Detecció de temps d'inactivitat
...
<body>
    <div class="container">
        ...
        <form action="../../private/controlador/save-match.controller.php" method="POST">
            <!-- FEEDBACK -->
            <?php
