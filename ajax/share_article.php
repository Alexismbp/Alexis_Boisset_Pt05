...
require_once __DIR__ . '/../models/shared_article.model.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Usar el modelo para guardar el artículo compartido
        $sharedArticle = new SharedArticle();
        if (!$sharedArticle->createSharedArticle($token, $article_id, $match_id, $titol, $cos)) {
            throw new Exception('Error al compartir el artículo');
        }
